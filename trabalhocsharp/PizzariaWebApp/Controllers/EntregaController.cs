...
namespace PizzariaWebApp.Controllers
{
    ...
    public class EntregaController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Entrega>> AddEntrega([FromBody] Entrega entrega)
        {
            if (entrega == null)
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateEntrega(int id, [FromBody] Entrega entrega)
        {
